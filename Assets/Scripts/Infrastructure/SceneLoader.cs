...
namespace Assets.Scripts.Infrastructure
{
    public class SceneLoader : ISceneLoader
    {
        ...
        public void LoadGameScene(Action onLoaded = null)
        {
            _coroutineRunner.StartCoroutine(LoadScene(_gameStaticData.GameScene, onLoaded));
        }

        public void LoadScreensaverScene(Action onLoaded = null)
        {
            _coroutineRunner.StartCoroutine(LoadScene(_gameStaticData.GameScreensaverScene, onLoaded));
        }
